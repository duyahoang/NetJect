...
def parse_ios_show_cdp_neighbor(cli_output: str) -> dict:
    """Parses the IOS CLI output of the show cdp neighbor command."""
    
    logging.info('Parsing ios "show cdp neighbor"...')
